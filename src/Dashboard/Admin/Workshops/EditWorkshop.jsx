                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  <div>
                    ...
                    <InputNumber
                      ...
                      onChange={(v) =>
                        handleBatchChange(index, "early_bird_price", v)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <InputNumber
                      ...
                      onChange={(v) =>
                        handleBatchChange(index, "early_bird_capacity", v)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <InputNumber
                      ...
                      onChange={(v) =>
                        handleBatchChange(index, "regular_price", v)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <InputNumber
                      ...
                      onChange={(v) =>
                        handleBatchChange(index, "on_the_spot_price", v)
                      }
                    />
                  </div>
                </div>
